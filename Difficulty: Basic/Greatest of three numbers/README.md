<h2><a href="https://www.geeksforgeeks.org/problems/greatest-of-three-numbers2520/1?selectedLang=java">Greatest of three numbers</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given 3 numbers a, b and c. Find the greatest number among them.</span></p>
